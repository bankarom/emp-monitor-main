    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-9 w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-7">
                ...
                <div><label className="flex items-center gap-1 text-xs font-semibold text-slate-600 mb-1">{t("tasks.dateRange")} {/* #114 — wrap in span so the title tooltip fires on hover */}<span title={t("dateRangeTooltip")} className="inline-flex cursor-help"><Info className="w-3 h-3 text-blue-500" /></span></label><DateRangeCalendar startDate={filters.startDate} endDate={filters.endDate} onChange={handleDateRangeChange} /></div>
            </div>
